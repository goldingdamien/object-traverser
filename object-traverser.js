...
class ObjectTraverser {
  /**
   * @deprecated Use https://github.com/rhalff/dot-object
   ...
   *
   * @param {Object} curObj
   * @param {(Object<string, *>[])} parents array of parent objects
   * @return {Boolean}
   */
   ...
   *  return val;
   * }
   * @param {(Object<string, *>)[]} looped array of checked items to avoid circular object error.
   ...
   */
  static deepCopyObject(obj) { // TODO: Needs test
    var copy = {}
    ObjectTraverser.loopObjectComplex(obj, function (status) {
   ...
   * @param {string[]} pathArr Array path(does not include object or value)
   ...
   * Not exactly the same, but it is recommended to use dot-object for setting object value: https://github.com/rhalff/dot-object
   *
   * @param {Object} obj
